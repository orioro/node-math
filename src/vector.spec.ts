...
describe('vectorUnit(vector)', () => {
  test('', () => {
    ...
    expect(vectorUnit([20, 10])).toEqual(vectorUnit([1, .5]))
  })
})

describe('vectorRound(vector)', () => {
  test('', () => {
    expect(vectorRound([0.1, 0.4, 0.5, 0.6, 0.9]))
      .toEqual([0, 0, 1, 1, 1])
  })
})
...
describe('vectorCeil(vector)', () => {
  test('', () => {
    expect(vectorCeil([0.1, 0.4, 0.5, 0.6, 0.9]))
      .toEqual([1, 1, 1, 1, 1])
  })
})
...
describe('vectorFloor(vector)', () => {
  test('', () => {
    expect(vectorFloor([0.1, 0.4, 0.5, 0.6, 0.9]))
      .toEqual([0, 0, 0, 0, 0])
  })
})
